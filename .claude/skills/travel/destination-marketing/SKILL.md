...
description: Create a destination marketing with structured process, quality checks, and system integration
---
...
Create a comprehensive destination marketing that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing destination marketing documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the destination marketing
...
- Structure the destination marketing using the output format below
