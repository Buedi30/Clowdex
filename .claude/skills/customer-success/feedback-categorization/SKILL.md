...
description: Create a feedback categorization with structured process, quality checks, and system integration
---
...
Create a comprehensive feedback categorization that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing feedback categorization documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the feedback categorization
...
- Structure the feedback categorization using the output format below
