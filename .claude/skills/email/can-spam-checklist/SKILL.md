---
name: can-spam-checklist
description: Analyze and produce a can spam checklist with structured process, quality checks, and system integration
---
...
Analyze and produce a comprehensive can spam checklist that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing can spam checklist documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Structure the can spam checklist using the output format below
