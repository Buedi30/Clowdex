---
name: ir-playbook
description: Create a incident response playbook with structured process, quality checks, and system integration
---
...
Create a comprehensive incident response playbook that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
