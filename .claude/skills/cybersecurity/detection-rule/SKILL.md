---
name: detection-rule
description: Create a detection rule / siem use case with structured process, quality checks, and system integration
---
...
Create a comprehensive detection rule / siem use case that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
