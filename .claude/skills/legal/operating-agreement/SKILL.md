...
description: Create a operating agreement with structured process, quality checks, and system integration
---
...
Create a comprehensive operating agreement that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing operating agreement documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Structure the operating agreement using the output format below
