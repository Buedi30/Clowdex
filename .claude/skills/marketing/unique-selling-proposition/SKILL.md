...
Create a comprehensive unique selling proposition that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing unique selling proposition documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the unique selling proposition
...
- Structure the unique selling proposition using the output format below
