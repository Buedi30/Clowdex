---
name: bid-submission
description: Create a bid submission with structured process, quality checks, and system integration
---
...
Create a comprehensive bid submission that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing bid submission documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the bid submission
...
- Structure the bid submission using the output format below
