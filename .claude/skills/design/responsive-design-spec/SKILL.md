...
Create a comprehensive responsive design spec that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing responsive design spec documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the responsive design spec
...
- Structure the responsive design spec using the output format below
