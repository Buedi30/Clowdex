...
description: Create a theory of change with structured process, quality checks, and system integration
---
...
Create a comprehensive theory of change that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing theory of change documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the theory of change
...
- Structure the theory of change using the output format below
