---
name: book-proposal
description: Create a book proposal with structured process, quality checks, and system integration
---
...
Create a comprehensive book proposal that delivers actionable, measurable results. This skill provides a structured process with quality validation, ensuring professional-grade output every time.
...
- Review any existing book proposal documents in the project
- Check knowledge-base.md for relevant learned rules or constraints
...
- Apply the selected framework to structure the book proposal
...
- Structure the book proposal using the output format below
